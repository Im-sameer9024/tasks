  ...
  return (
    <div className="w-full overflow-x-hidden bg-slate pt-[8rem]">
      <div className="w-10/12 flex flex-col mx-auto items-center ">
        ...
        <h1 className=" text-[3rem] font-heading font-semibold">Why Book with Us</h1>
        ...
        <div className=" flex flex-col items-center my-[3rem]">
          ...
          <div className=" flex justify-between items-center">
            ...
            <div className=" w-5/12 relative">
              <img src={img1} alt="img1" className=" w-[19.75rem] h-[27.8rem]" />
              <img src={img2} alt="img2" className=" absolute w-[14.25rem] h-[21.25] top-[6rem] left-[13rem]" />
            </div>
            {/* information   */}
          ...
          <div className=" flex justify-between mt-[3rem]">
            ...
            <div className="w-2/12 flex flex-col gap-3 item-center justify-center text-center">
              ...
              <p className="font-text">
              Access exclusive deals, discounts, and perks that maximizing the value of your budget.
              </p>
            </div>
